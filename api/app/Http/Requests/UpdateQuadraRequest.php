...
class UpdateQuadraRequest extends FormRequest
{
    ...
    {
        // Apenas admin pode atualizar quadras
    ...
    {
        $quadraId = $this->route('id'); // ID da quadra sendo atualizada

        return [
            'nome' => 'sometimes|required|string|max:100|unique:quadras,nome,' . $quadraId . ',id_quadra',
            'localizacao' => 'nullable|string|max:255',
            'esporte' => 'sometimes|required|string|in:beach_tennis,tenis,futsal,volei,basquete,outros',
            'preco_hora' => 'sometimes|required|numeric|min:0|max:9999.99',
